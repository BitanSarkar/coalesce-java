...
objects — that is the entirety of what makes this distributed:
...
- `02-aspect.md` — the full `CoalesceAspect`: entry point, leader path, follower wait
  loop, stale-while-revalidate branch
