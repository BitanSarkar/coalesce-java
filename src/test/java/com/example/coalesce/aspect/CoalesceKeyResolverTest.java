...
class CoalesceKeyResolverTest {
    ...
    void lockBucketAndTopicGetDistinctKeysSharingOneHashTag() throws Exception {
        ...
        String state = RedissonCoalesceCoordinator.discriminate(key, "state");
        String lock = RedissonCoalesceCoordinator.discriminate(key, "lock");
        String notify = RedissonCoalesceCoordinator.discriminate(key, "notify");
